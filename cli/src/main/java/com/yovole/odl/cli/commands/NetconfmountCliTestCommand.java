 ...
 */
package com.yovole.odl.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import com.yovole.odl.cli.api.NetconfmountCliCommands;
...
public class NetconfmountCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(NetconfmountCliTestCommand.class);
    protected final NetconfmountCliCommands service;

    public NetconfmountCliTestCommand(final NetconfmountCliCommands service) {
